...
export const Projects = () => (
  ...
  >
    <div className="grid md:grid-cols-2 gap-6">
      {projects.map((p, i) => {
        const Comp: any = p.link ? motion.a : motion.article;
        ...
        return (
          <Comp
            ...
            whileHover={{ y: -6 }}
            className={`group relative glass rounded-3xl p-7 overflow-hidden hover:border-primary/40 transition-smooth block ${p.link ? "cursor-pointer" : ""}`}
          >
